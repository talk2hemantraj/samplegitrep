...
public class Ecommerce4 extends EcomBase{
	...
	public static double getAmount(String value)
	{
		 ...
		 * get(0).getText(); //120.0 amount1 = amount1.substring(1); double amount1Value
		 * = Double.parseDouble(amount1); System.out.println(amount1Value);
		 * 
		 * 
		 * String amount2 =
		 * driver.findElements(By.id("com.androidsample.generalstore:id/productPrice")).
		 * get(1).getText(); //120.23 amount2 = amount2.substring(1); double
		 ...
		 * .getText(); total = total.substring(1); double totalValue =
		 * Double.parseDouble(total); System.out.println(totalValue);
		 * 
		 * try { Assert.assertEquals(totalAmount, totalValue); } catch (AssertionError
		 * e) { System.out.println("Not equal"); throw e; } System.out.println("Equal");
		 */
